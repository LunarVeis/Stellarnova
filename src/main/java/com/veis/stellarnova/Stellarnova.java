...
@Mod(Stellarnova.MODID)
public class Stellarnova
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "stellarnova";
    ...
    public Stellarnova(IEventBus modEventBus, ModContainer modContainer)
    {
